...
function ThanhToan() {
    const {listCart,giamSL,tangSL,handleDelete,handDeleteAll,tongSoLuong,tongThanhTien}=HookGioHang();
    let user:any={}
    ...
    <div className="cart-chitiet__box flex justify-between gap-3">
      ...
      <div className="cart-chitiet__right">
        ...
        <div className="cart-chitiet__tong">
          <div className="flex justify-between font-semibold"><span>Số lượng:</span>{tongSoLuong}</div>
          <div className="flex justify-between font-semibold"><span>Tổng tiền:</span>{tongThanhTien.toLocaleString()}đ</div>
        </div>
      </div>
    </div>
  </div>
