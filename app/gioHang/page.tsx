            ...
            <td className="text-center">
              <div className="soLuong flex justify-center items-center">
                <div className="tru flex justify-center items-center">
                  <button onClick={()=>{giamSL(item._id)}}>
   <LuMinus />
                  </button>
    ...
    <div className="cart-right" style={{width: 400,background:"white"}}>
      <div className="bg-white">
        ...
        <div>
          <p className="flex justify-between">Số lượng: <span className="font-semibold">{tongSoLuong}</span></p>
          <p className="flex justify-between">Thành tiền:
            :<span className="font-semibold">{tongThanhTien.toLocaleString()}đ
            </span></p>
        </div>
        ...
        <p className="flex justify-between">Tổng thanh toán:
          : <span className="font-semibold text-danger">{tongThanhTien.toLocaleString()}đ</span></p>
          <button className="btn btn-info mt-2 w-[100%] h-[35px] rounded-lg">
          <a href="/thanhToan" >Mua Ngay</a>
          </button>
